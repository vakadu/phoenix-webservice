		...
		return (
			<button 
				...
				className={cn(
					...
					className,
					!disabled ? buttonColorClassNames : 'cursor-not-allowed bg-grey-disabled',
					sizeClassNames,
					shapes[shape],
					uppercase && 'uppercase',
					variants[variant],
			...
			>
				{
					isLoading && 
						<>
							<svg role="status" className={`animate-spin w-18 h-18 text-transparent fill-white`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
