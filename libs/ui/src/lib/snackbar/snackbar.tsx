...
import { PemilyRootState, setClose } from '@webservices/slices';
...
export function Snackbar(props: SnackbarProps) {
	...
	const { message, open, duration, showCloseButton = true, actionButton, btnText = 'close' } = useSelector((state: PemilyRootState) => state.snackbar);
			...
			<section className='px-8 lg:px-12 py-8 bg-[#323232] rounded-6 flex justify-between items-center'>
				...
				{showCloseButton && (
					<button
						...
						className="text-white ml-12 text-24"
					>
						&times;
					</button>
				)}
